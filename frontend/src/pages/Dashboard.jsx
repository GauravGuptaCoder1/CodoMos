              ...
              <TabPanel px={0}>
                <VStack spacing={6} align="stretch">
                  <Flex justify="space-between" align="center">
                    ...
                    <Button colorScheme="blue">Start Self Assessment</Button>
                  </Flex>
                      ...
                      <Card key={review.id} _hover={{ shadow: "lg" }}>
                        ...
                        <CardBody pt={0}>
                          <VStack align="stretch" spacing={3}>
                            ...
                            <Button size="sm" colorScheme={review.status === "Completed" ? "gray" : "blue"} variant={review.status === "Completed" ? "outline" : "solid"}>
                  ...
                  <Card>
                    ...
                    <CardBody>
                      <SimpleGrid columns={{ base: 1, md: 2, lg: 4 }} spacing={4} mb={4}>
                        <Button colorScheme="blue" size="sm">Self-Assessment Form</Button>
                        <Button colorScheme="purple" size="sm">Manager Review</Button>
                        <Button colorScheme="green" size="sm">Peer Review</Button>
                        <Button colorScheme="orange" size="sm">360° Dashboard</Button>
                      </SimpleGrid>
                  ...
                  <Card>
                    <CardHeader>
                      <Flex justify="space-between" align="center">
                        ...
                        <Button colorScheme="blue" size="sm">Create New Cycle</Button>
                      </Flex>
                    </CardHeader>
                    <CardBody>
                        ...
                        <Tbody>
                          {performanceData.reviewCycles.map((cycle) => (
                            <Tr key={cycle.id}>
                              ...
                              <Td><Button size="xs" colorScheme="blue">Manage</Button></Td>
                            </Tr>
                          ))}
                        </Tbody>
                      </Table>
                  ...
                  <Card>
                    <CardHeader>
                      <Flex justify="space-between" align="center">
                        ...
                        <Button colorScheme="blue" size="sm">Schedule 1:1</Button>
                      </Flex>
                    </CardHeader>
                    <CardBody>
                  ...
                  <Card>
                    ...
                    <CardBody>
                      <SimpleGrid columns={{ base: 1, md: 3 }} spacing={4}>
                        <Card variant="outline" _hover={{ borderColor: "blue.500", shadow: "md" }} cursor="pointer">
                          <CardBody>
                  ...
                  <Card>
                    <CardHeader>
                      <Flex justify="space-between" align="center">
                        ...
                        <Button colorScheme="orange" size="sm">Create PIP</Button>
                      </Flex>
                    </CardHeader>
                    <CardBody>
                          ...
                          <Tbody>
                            {performanceData.pips.map((pip) => (
                              <Tr key={pip.id}>
                                ...
                                <Td><Button size="xs" colorScheme="blue">Review</Button></Td>
                              </Tr>
                            ))}
                          </Tbody>
                        </Table>
